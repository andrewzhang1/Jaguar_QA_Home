...
#: Script Name: import_export.sh 
#: Authors: Andrew Zhang
#: Reviewers: 
#: Date: 10/17/2017
#: Purpose:     Data import export for feature of jagexport and jagimport
#: Test cases: 
#       Use case 1: 
#       -------------------------------------------------------------------
#
...
echo "Hi, Andrew" 2>&1 | tee -a $logf

sshall rm -rf  $JAGUAR_HOME/export/*  2>&1 | tee -a $logf 
...
echo -e "============================== \n"  2>&1 | tee -a $logf 
loginj < $QA_HOME/sql/import_export.sql 2>&1 | tee -a $logf 
